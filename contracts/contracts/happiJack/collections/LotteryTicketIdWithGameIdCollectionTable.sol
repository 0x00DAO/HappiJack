...
bytes32 constant _tableId = bytes32(
    keccak256(
        abi.encodePacked(
            "tableId",
            "HappiJack",
            "LotteryTicketIdWithGameIdCollectionTable"
        )
    )
);
bytes32 constant LotteryTicketIdWithGameIdCollectionTableId = _tableId;

library LotteryTicketIdWithGameIdCollectionTable {
        ...
        returns (string memory, string[] memory)
    {
        ...
        return ("LotteryTicketIdWithGameIdCollectionTable", _fieldNames);
    }
