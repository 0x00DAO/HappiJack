...
bytes32 constant LotteryGameHistoryGameCollectionTableId = _tableId;

bytes32 constant KeyHistory = bytes32(
    keccak256(abi.encodePacked("KeyHistory"))
);

library LotteryGameHistoryGameCollectionTable {
