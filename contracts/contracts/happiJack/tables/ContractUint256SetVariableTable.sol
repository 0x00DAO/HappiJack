...
bytes32 constant _tableId = bytes32(
    keccak256(
        abi.encodePacked(
            "tableId",
            "HappiJack",
            "ContractUint256SetVariableTable"
        )
    )
);
bytes32 constant ContractUint256SetVariableTableId = _tableId;

library ContractUint256SetVariableTable {
        ...
        returns (string memory, string[] memory)
    {
        ...
        return ("ContractUint256SetVariableTable", _fieldNames);
    }
