...
import {MiniGameBonusSystem, ID as MiniGameBonusSystemID} from "./MiniGameBonusSystem.sol";

uint256 constant ID = uint256(
    keccak256("game.systems.MiniGameBonusSystemAgent")
);

contract MiniGameBonusSystemAgent is
    Initializable,
    PausableUpgradeable,
    UUPSUpgradeable,
    System,
